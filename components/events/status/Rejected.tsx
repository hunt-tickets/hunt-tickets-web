// components/status/Rejected.tsx
"use client";
...
const Rejected = () => (
  <div className="flex h-[calc(100vh-100px)] w-full flex-col items-center justify-center gap-10 bg-default-background px-4 py-4">
    <div className="flex flex-col items-center justify-center gap-4">
      <IconWithBackground variant="error" size="large" icon="FeatherX" />
      <div className="flex w-144 flex-col items-center justify-center gap-4">
        ...
        <span className="text-heading-3 font-heading-3 text-subtext-color text-center">
          Parece que algo no salió como esperábamos.
        </span>
        <span className="text-body font-body text-subtext-color text-center">
          Tu pago no se procesó correctamente. Te recomendamos intentar
          nuevamente con otro método de pago o volver a intentarlo más tarde.
        </span>
      </div>
    </div>
    ...
    <div className="flex w-144 flex-col items-center gap-6">
      <div className="flex flex-col items-center justify-center gap-4">
        ...
        <div className="flex w-144 items-center gap-4">
          ...
          />
          <span className="grow shrink-0 basis-0 text-body font-body text-default-font">
            También te llegará una notificación a Whatsapp con la confirmación
            de tu compra
          </span>
        </div>
      </div>
      <span className="text-body-bold font-body-bold text-subtext-color text-center">
        Es la misma boleta enviada por diferentes medios, no necesitas usarlas
        todas. Puedes mostrarla desde cualquiera de ellos.
      </span>
    </div>
  </div>
);
