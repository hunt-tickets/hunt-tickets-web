...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "w-full border-b border-solid border-neutral-border inline-flex h-9 justify-start bg-transparent pt-1 text-muted-foreground",
      className
    )}
    {...props}
  />
