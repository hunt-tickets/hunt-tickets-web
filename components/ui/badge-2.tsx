...
const badgeVariants = cva(
  'inline-flex items-center justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0',
  {
    variants: {
      ...
      size: {
        lg: 'rounded-md px-2 h-7 min-w-7 gap-1.5 text-xs [&_svg]:w-3.5 [&_svg]:h-3.5',
        md: 'rounded-md px-2 h-6 min-w-6 gap-1.5 text-xs [&_svg]:w-3.5 [&_svg]:h-3.5',
        sm: 'rounded-sm px-1 h-5 min-w-5 gap-1 text-xs [&_svg]:w-3 [&_svg]:h-3',
        xs: 'rounded-sm px-1 h-4 min-w-4 gap-1 text-xs [&_svg]:w-3 [&_svg]:h-3',
      },
      shape: {
        default: '',
        circle: 'rounded-full',
...
const badgeButtonVariants = cva(
  'cursor-pointer transition-all inline-flex items-center justify-center leading-none w-3.5 h-3.5 [&>svg]:opacity-100 [&>svg]:w-3.5 [&>svg]:h-3.5 p-0 rounded-md -me-0.5 opacity-60 hover:opacity-100',
  {
    variants: {
      variant: {
        default: '',
