  ...
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      ...
      size: {
        ...
        md: 'h-8 rounded-md px-3 gap-1.5 text-sm [&_svg:not([class*=size-])]:w-4 [&_svg:not([class*=size-])]:h-4',
        sm: 'h-7 rounded-md px-2.5 gap-1 text-xs [&_svg:not([class*=size-])]:w-3.5 [&_svg:not([class*=size-])]:h-3.5',
        icon: 'w-8 h-8 rounded-md [&_svg:not([class*=size-])]:w-4 [&_svg:not([class*=size-])]:h-4 shrink-0',
      },
      autoHeight: {
        true: '',
        false: '',
    ...
    compoundVariants: [
      ...
      },
      {
        size: 'md',
        mode: 'icon',
        className: 'w-8 h-8 p-0 [&_svg:not([class*=size-])]:w-4 [&_svg:not([class*=size-])]:h-4',
      },
      {
        size: 'icon',
        className: 'w-8 h-8 p-0 [&_svg:not([class*=size-])]:w-4 [&_svg:not([class*=size-])]:h-4',
